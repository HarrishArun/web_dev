...
const Portfolio = () => {
  ...
  return (
    <div name='portfolio' className=' bg-gradient-to-b to-black from-gray-800 w-full text-white md:h-full flex items-centes justify-center '>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center  w-full md:m-16  '>
            <div className='pb-8 '>
            <p className=' text-[#02ecff] text-2xl sm:text-4xl font-bold inline border-b-4 border-gray-500'>Projects</p>
            <p className='py-4 text-sm sm:text-xl'>Check out my recent works here</p></div>
           
            <div className='grid grid-cols-2 md:grid-cols-3 sm: gap-8  px:0 '>
  ...
  <figure><img src={src} alt='projects' /></figure>
  <div className="card-body">
    <h2 className="text-base font-bold mr-3 sm:card-title ">
      {title+' '}
      <div className={` badge text-black font-bold ${style}`}>{language}</div>
    </h2>
